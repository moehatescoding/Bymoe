    ...
    <main className="min-h-screen bg-brand-black pb-32 pt-20 sm:pt-28 px-4 sm:px-8 md:px-12 max-w-7xl mx-auto overflow-x-hidden">
      ...
      <div className="mb-10 sm:mb-14 text-left border-b border-white/[0.08] pb-8 sm:pb-10">
        ...
        <motion.p
          ...
          className="text-sm sm:text-lg text-white/60 max-w-2xl font-light leading-relaxed mb-6"
        >
        ...
        >
          <a
            ...
            data-cursor="JOIN"
            className="inline-flex w-full sm:w-auto justify-center items-center gap-3 px-6 py-3.5 rounded-xl bg-white/5 border border-white/10 hover:bg-[#00ff66] hover:text-black hover:border-[#00ff66] active:scale-[0.97] transition-all cursor-pointer text-xs font-mono font-bold uppercase tracking-wider text-white"
          >
            ...
            <span>FOLLOW @MOEGICAL // INSTAGRAM</span>
          </a>
        </motion.div>
      </div>
