  ...
  return (
    <main className="min-h-screen">
      ...
      <section className="relative min-h-[90vh] flex items-center bg-surface-container-low overflow-hidden">
        ...
        <div className="relative z-10 max-w-container-max mx-auto px-6 md:px-margin-desktop pt-60 pb-12 md:pb-20 text-center md:text-left flex flex-col items-center md:items-start">
