            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-10 pb-12 border-b border-surface-variant">
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="flex gap-4 mt-2">
                  <a href="https://www.instagram.com/bymoe.in/" target="_blank" rel="noopener noreferrer" className="text-on-surface-variant hover:text-primary transition-colors">
              ...
              {/* Security */}
              <div className="flex flex-col gap-4">
                <p className="text-label-sm text-on-surface-variant uppercase tracking-widest mb-1">Secure Shopping</p>
                <div className="flex flex-col gap-3">
                  <div className="flex items-center gap-3 text-body-md text-on-surface-variant">
                    <span className="w-8 h-8 rounded-full bg-surface flex items-center justify-center text-secondary border border-surface-variant text-[14px]">✓</span>
            ...
            <div className="flex flex-col sm:flex-row justify-between items-center gap-6 pt-10">
              <div className="flex items-center gap-8">
                ...
                <div className="hidden sm:flex items-center gap-4 opacity-40">
                  <span className="text-[10px] uppercase font-bold border border-on-surface-variant px-1 rounded">SSL</span>
                  <span className="text-[10px] uppercase font-bold border border-on-surface-variant px-1 rounded">HTTPS</span>
                  <span className="text-[10px] uppercase font-bold border border-on-surface-variant px-1 rounded">SECURE</span>
                </div>
              </div>
              <div className="flex items-center gap-6">
                ...
                <a href="https://www.instagram.com/bymoe.in/" target="_blank" rel="noopener noreferrer" className="text-label-sm text-on-surface-variant hover:text-primary">Instagram</a>
              </div>
            </div>
          </div>
        </footer>
