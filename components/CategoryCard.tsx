...
export default function CategoryCard({ category }: { category: Category }) {
  return (
    <Link href={`/category/${category.slug}`} className="group block rounded-xl overflow-hidden relative aspect-[4/5] bg-surface-container-low img-zoom shadow-card hover:shadow-card-hover transition-shadow">
